...
# except: # catches all types of execution
...
#         print("That\'s not a valid number")
#     else:
#         print("Number input successful with no exception")
#         break
# print( type(x) )
...
# To read file , first they are opened and strored in a variable
...
# read() method -- reads text contanined in file and returns it as string
...
# files should be closed. open files has limit according to operating system
...
print(demo_script.num)   # it will import num=8 from demo_script.py file
...
print(d.__name__) # the scripts imported gets __name__ value as "imported_script_name"
...
# sys: work directly with Python interpreter
...
# not recommend in code -- creates confusion
from math import *
...
# after installation, the packages can be imported same as standarad library packages

# requirements.txt file is standard convention to specify required packages

# eg. (foll. data present as text in requiremnts.txt)
...
# requests - Provides easy to use methods to make web applications and APIs.
...
# Pillow - The Python Imaging Library adds image processing capabilites to your Python interpreter.
...
# ! to executer system shell commands
