...
if is_raining and is_sunny:
    print("is there a rainbow?")    # if both are true then this will get executed
else:
    print("There is no rainbow")    # if on of them are false this will get executed
unsubscibed = False
location = "CAN"
if ( not unsubscibed) and ((location) == "USA" or location == "CAN"):
    print("send email")
else:
...
if weather == "snow" or "rain":   # the right part of "or" i.e "rain" is a string and not a boolean expression
    ...
    print("No boots are required")  # else part is not executing properly
...
# Don't compare a boolean variable with "==True" OR "==False" as they themselves evaluate to True of False
is_cold=True
if is_cold == True:
    print("Weather is cold")

# instead use the varialbes directly
...
# Objects defined to false: "None" & "False"
...
# in the "wear boots" example, the string on the right hand side "rain" would always evaluate to true as it is non empty string
if weather =="hell" or "":  # "" will always evaluate to false, thus the result depends on truth value of the expression on left 'weather == "hell"'
    print("Boots are not required")

# FOR LOOPS

# A for loop is used to "iterate", or do a task repeatedly, over an iterable.

# Iterable -- It is an object that can retun one of its elements at a time.
...
# start -- is the first number of sequence ( 0 if unspecified) 
...
print( list( range(2,6)))  # start=2, stop =6 prints [2,3,4,5]

#caaling range with three integers
...
print(cities)       # Each city name is capitalized

for i in range(4):
    print("Hello")      # Prints Hello 4 times each one at a new line
...
for number in range(5,31,5):   # start=5, stop=31, step =5
    print(number)
# prints 5 10 15 20 25 30 in each new line
    
# save each name in usename with all lowercase letters and underscore instead of space
names = ["Joey Tribbiani","Monica Geller", "Chandler Bing", "Phoebe Buffay"]
usernames = []

for index in range( len(names) ):
    usernames.append( names[index].lower().replace(" ","_"))   # .lower() method converts all letters into small letters and .replace() method is used to replace the blank spaces to '_' underscores.
print(usernames)
...
for name in names:
    ...
    # this will assign the changed value to the iterating variable name but not assign it to the nameslist as no such command is given. It just extracts and changes value of the iterating variable
print(names) 


# The printed output for the names list will look like it did in the first line.
...
# iterating through loop for definite no. of times with range() function

# while loops are ideal when the iterations need to continue until a condition is met

# comparison operator, loops based on receivning specific user input
...
# Write a loop with a break statement to create a string,news_ticker,that is exactly 140 characters long. You should create the news ticker by adding headlines from the headlines list, inserting a space in between each headline. If necessary, truncate the last headline in the middle so that new_ticker is exactly 140 characters long.

headlines = ["Local Bear Eaten by Man",
             "Legislature Announces New Laws",
             "peasant Discovers Violence Inherent in System",
             "Cat Rescues Fireman Struck in Tree",
...
# Use zip() to transpose data from a 4-by-3 matix to a 3-by-4 matrix. There's actually a cool trick for this! Feel freeto look at the solutions if you can't figureit out.
...
names = ["Rick Sanchez", "Morty Smith", "Jerry Smith", "Beth Smith"]
