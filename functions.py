...
print(answer2) # global variables in the smallest scope they will be needed in.
...
# filter() function -- Function that takes a function and an iterable as inputs and returns an iterator with the 
